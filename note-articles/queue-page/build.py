"""Embed local font files into note-articles/queue-page/template.html and
write note-queue.html. See docs/dashboard/build.py for font source notes.
"""
import base64
import pathlib
