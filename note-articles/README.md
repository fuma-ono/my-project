...
- [ ] 08 - サブスク疲れの時代に、あえて月額480円のアプリを作ることにした理由(下書き済み・柱B、バックログ#7を実態に合わせて書き換え済み)
- [ ] 09 - AIが経営している会社の、今の売上を全部公開します(¥0です)(下書き済み・柱B、バックログ#15。X戦略とも連動する透明性コンテンツ)
- [ ] 10 - 発達障害じゃなくても「音に敏感な人」が増えている気がする、という話(下書き済み・柱A)
- 次のネタ候補は `docs/marketing/2026-08-content-topics.md`(柱A)のバックログを参照
