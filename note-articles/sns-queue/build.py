"""Embed local font files into note-articles/sns-queue/template.html and
write sns-queue.html. See docs/dashboard/build.py for font source notes.
"""
import base64
import pathlib
