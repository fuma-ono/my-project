...
import { KeyboardAvoidingView, Modal, Platform, ScrollView, Text, TextInput, View, StyleSheet } from 'react-native';
...
export default function FeedbackModal({ visible, onClose, onSubmit }: Props) {
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={close}>
      {/* 104回目: 「ご意見・不具合を報告」の入力欄がキーボードと重なって
          送信ボタンまで隠れ、キーボードも閉じられず操作不能になる不具合
          への対応。LoginSheet.tsxと同じくKeyboardAvoidingView+ScrollView
          で、キーボード表示中も送信ボタンまでスクロールして届くようにする。 */}
