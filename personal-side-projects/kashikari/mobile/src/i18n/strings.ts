...
export const ja = {
  ...
  groupSettings: {
    ...
    namePlaceholder: '例: 大学の友達',
    savedNote: '保存しました',
    // 「アイコンとグループ名の変更だけじゃ寂しい」という指摘への
    // 対応(89回目)で追加した項目。
    inviteLabel: '招待コード',
    inviteShareButton: '共有する',
    muteLabel: 'このグループの通知をミュート',
    muteDescription: 'オンにすると、このグループのプッシュ通知が届かなくなります(通知の履歴には引き続き残ります)',
    muteFailedTitle: '変更できませんでした',
    membersLabel: 'メンバー',
    removeMemberConfirmTitle: (name: string) => `${name}さんをグループから外しますか?`,
    ...
    // サークル会計(97回目)。管理者のみ設定・停止できる。
    duesLabel: '会費(サークル会計)',
    duesActiveNote: (amount: string) => `月額${amount}を、毎月自動で未払い記録として作成しています。`,
    duesReadOnlyNote: (amount: string) => `このグループの会費は月額${amount}です(管理者が設定)。`,
    duesAmountPlaceholder: '金額(円)',
    duesSetButton: '会費を設定する',
    duesSetFailedTitle: '設定できませんでした',
    duesStopButton: '会費を停止する',
    duesStopConfirmTitle: '会費の徴収を停止しますか?',
    duesStopConfirmMessage: '来月以降、自動での未払い記録の作成が止まります。過去の記録は残ります。',
    duesStopConfirmButton: '停止する',
    duesStopFailedTitle: '停止できませんでした',
    dangerZoneLabel: '危険な操作',
    deleteGroupButton: 'グループを削除する',
    deleteGroupConfirmTitle: (groupName: string) => `「${groupName}」を削除しますか?`,
    deleteGroupConfirmMessage: 'メンバー全員がこのグループのデータにアクセスできなくなります。この操作は取り消せません。',
    deleteGroupConfirmButton: '削除する',
    deleteGroupFailedTitle: '削除できませんでした',
  },
  avatarPicker: {
    title: 'アイコンを選ぶ',
    photoButton: '写真から選ぶ',
  ...
  // 会計レポート(96回目、Premium特典)。グループ横断で月ごとの
  // 支払い/受け取り合計を見る画面。
  report: {
    back: '設定',
    title: '📈 会計レポート',
    lockedTitle: 'Premiumで会計レポートを見る',
    lockedMessage: 'グループ横断で、月ごとに支払った合計・受け取った合計をひと目で確認できます。',
    upgradeButton: 'Premiumに加入する',
    loading: '読み込み中...',
    emptyTitle: 'まだ記録がありません',
    emptyMessage: 'お金の記録が増えると、ここに月ごとの集計が表示されます',
    paidLabel: '支払った合計',
    receivedLabel: '受け取った合計',
    netLabel: '差引',
  },
  notifications: {
    back: '戻る',
...
export const en: Strings = {
  ...
  groupSettings: {
    ...
    muteLabel: 'Mute this group',
    muteDescription: "When on, you won't get push notifications from this group (they still show up in your notification history)",
    muteFailedTitle: "Couldn't change this",
    membersLabel: 'Members',
    removeMemberConfirmTitle: (name: string) => `Remove ${name} from this group?`,
    ...
    premiumBadge: 'Premium',
    duesLabel: 'Dues (club accounting)',
    duesActiveNote: (amount: string) => `A ${amount}/month unpaid entry is created automatically for each member.`,
    duesReadOnlyNote: (amount: string) => `This group's dues are ${amount}/month (set by the admin).`,
    duesAmountPlaceholder: 'Amount (JPY)',
    duesSetButton: 'Set dues',
    duesSetFailedTitle: "Couldn't set dues",
    duesStopButton: 'Stop dues',
    duesStopConfirmTitle: 'Stop collecting dues?',
    duesStopConfirmMessage: "New unpaid entries won't be created from next month on. Past entries stay as they are.",
    duesStopConfirmButton: 'Stop',
    duesStopFailedTitle: "Couldn't stop dues",
    dangerZoneLabel: 'Danger zone',
    deleteGroupButton: 'Delete this group',
    deleteGroupConfirmTitle: (groupName: string) => `Delete "${groupName}"?`,
    deleteGroupConfirmMessage: 'Every member will lose access to this group’s data. This cannot be undone.',
    deleteGroupConfirmButton: 'Delete',
    deleteGroupFailedTitle: "Couldn't delete the group",
  },
  avatarPicker: {
  ...
  report: {
    ...
    lockedTitle: 'See your accounting report with Premium',
    lockedMessage: 'See how much you paid and received each month, across all your groups.',
    upgradeButton: 'Get Premium',
    loading: 'Loading...',
    emptyTitle: 'No records yet',
    emptyMessage: "Monthly totals will show up here once you've logged some money entries",
    paidLabel: 'Total paid',
    receivedLabel: 'Total received',
    netLabel: 'Net',
  },
  notifications: {
    back: 'Back',
