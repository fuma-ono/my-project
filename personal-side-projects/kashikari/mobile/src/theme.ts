...
export const colors = {
  ...
  accentSoft: '#ffe4da',
  plum: '#6b3a78',
  // グループ画面ヘッダー専用の、少し落ち着かせたaccent/plum。「参考画像と
  // 比べて全然違う」という指摘を受け、参考画像のヘッダーから実際に
  // ピクセルの色を採取して合わせた値に差し替えた(横方向のグラデーション
  // のベース色。実際のヘッダーは、この上にさらに上から下へフェードする
  // 黒のオーバーレイ(headerShade)を重ねて、参考画像のような上が暗く
  // 下にいくほど明るくなる陰影を作っている)。
  headerAccent: '#c16654',
  headerPlum: '#6c4483',
  headerShadeTop: 'rgba(0,0,0,0.6)',
  headerShadeBottom: 'rgba(0,0,0,0)',
