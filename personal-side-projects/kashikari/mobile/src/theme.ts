...
export const colors = {
  ...
  accentSoft: '#ffe4da',
  plum: '#6b3a78',
  // グループ画面ヘッダー専用の、少し落ち着かせたaccent/plum。「グラデー
  // ションの色味は維持しつつ少し落ち着いた色に」という指摘への対応。
  // 彩度・明度を少し落としただけで、色相(オレンジ→紫)自体は変えていない。
  // FAB・主要ボタン・残高カードは引き続き鮮やかなaccent/plumのまま
  // (グラデーションを使う箇所を絞る、という方針の中でヘッダーだけ
  // トーンを分けている)。
  headerAccent: '#e8684e',
  headerPlum: '#5c3468',
