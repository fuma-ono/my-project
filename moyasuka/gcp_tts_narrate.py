...
from moyasuka.line_chat import HARSH_TRIGGER_WORDS, PAUSE_SECONDS, estimate_arrivals, is_pause_only, parse_chat_script, prepare_for_tts, timing_fingerprint, total_seconds_for
...
def build_narration(script_path: str, out_wav: str, out_durations_json: str) -> float:
    ...
    with TemporaryDirectory() as tmp:
        for i, item in enumerate(items):
            ...
            # (prepare_for_tts参照)——渡したままだとGoogle Cloud TTSが
            # 読み上げてしまう。
